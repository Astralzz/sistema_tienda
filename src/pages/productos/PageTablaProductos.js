...
import PageFormularioCategoria from "./PageFormularioCategoria";
import ModalRegistroProducto from "./ModalRegistroProducto";

// Tabla de usuarios
const PageTablaProductos = ({ titulo, sesion }) => {
  // Modal
      ...
      <div className="container">
        ...
        <div className="row gutters-sm">
          ...
          <div className="col-md-4 mb-3">
            ...
            {/* Parte de categorias */}
            <PageFormularioCategoria sesion={sesion} />
          </div>
            ...
            <Card className="card">
              <Card.Body className="card-body">
                ...
                <div className="text-dark">
                  <Pagination className="pagination-bg-dark">
                    {items}
                  </Pagination>
                </div>
              </Card.Body>
...
export default PageTablaProductos;
